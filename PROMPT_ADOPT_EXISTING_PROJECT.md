...
- Repository URL / local path: https://github.com/JWebMP/AgCharts.git
- Org and project name: JWebMP / AG Charts Angular
- Short description:  A plugin for the JWebMP renderer that leverages the typescript and angular plugins to render 
