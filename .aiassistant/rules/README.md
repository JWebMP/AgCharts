...
- AgCharts topic rules live at `rules/generative/frontend/jwebmp/agcharts/README.md` (use alongside client/typescript/angular rules); enterprise extras under `.../agcharts-enterprise/README.md`.
