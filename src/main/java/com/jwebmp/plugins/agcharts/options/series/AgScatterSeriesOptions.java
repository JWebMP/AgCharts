...
/**
 * Scatter Series options for AG Charts (community).
 *
 * Aligns with AgScatterSeriesOptions API: x/y keys, optional labelKey/labelName,
...
public class AgScatterSeriesOptions<J extends AgScatterSeriesOptions<J>> extends AgSeriesBaseOptions<J> {
    ...
    // --- Label key for per-point labels ---
    ...
    // --- Highlight is inherited from base via setHighlight/getHighlight ---
    ...
    // --- Labels ---
    private AgScatterSeriesLabelOptions<?> label;

    // --- Marker-like styling directly on series (for convenience) ---
    private Integer size;              // marker size
