...
public class AgNavigatorOptions<J extends AgNavigatorOptions<J>> extends JavaScriptPart<J>
{
    ...
    public @org.jspecify.annotations.NonNull J setMask(AgNavigatorMaskOptions<?> mask) { this.mask = mask; return (J) this; }

    public AgNavigatorHandleOptions<?> getMinHandle() { return minHandle; }
    public @org.jspecify.annotations.NonNull J setMinHandle(AgNavigatorHandleOptions<?> minHandle) { this.minHandle = minHandle; return (J) this; }

    public AgNavigatorHandleOptions<?> getMaxHandle() { return maxHandle; }
    public @org.jspecify.annotations.NonNull J setMaxHandle(AgNavigatorHandleOptions<?> maxHandle) { this.maxHandle = maxHandle; return (J) this; }

    public AgNavigatorMiniChartOptions<?> getMiniChart() { return miniChart; }
    public @org.jspecify.annotations.NonNull J setMiniChart(AgNavigatorMiniChartOptions<?> miniChart) { this.miniChart = miniChart; return (J) this; }
}
